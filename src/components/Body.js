...
const Body = () => {
    ...
    const fetchData = async () => {
        const data = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=17.541192&lng=78.366166&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
