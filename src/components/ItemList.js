        ...
        <div key={index} className="p-2 m-2 border-gray-200 py-8 border-b-2 flex justify-between items-start">
            ...
            <div className="w-1/4 flex justify-end">    
                <div className="relative">
                    ...
                    <button className=" cursor-pointer absolute bottom-[-11px] left-1/2 -translate-x-1/2 bg-white text-green-600 font-semibold px-4 py-1 rounded-lg shadow-md border">
                        ADD
                    </button>
                </div>
            </div>
